  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="bg-gray-900 p-10 rounded-3xl max-w-md w-full">
        <h2 className="text-4xl text-white text-center mb-8">Welcome back</h2>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl text-xl font-bold"
          >
